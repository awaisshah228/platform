...
const commentCtrl = {
    ...
    getComments: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const data = yield commentModel_1.Comment.aggregate([
                {
                    $facet: {
                        totalData: [
                            { $match: {
    ...
    replyComment: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            yield commentModel_1.Comment.findOneAndUpdate({ _id: comment_root }, {
    ...
    updateComment: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const comment = yield commentModel_1.Comment.findOneAndUpdate({
    ...
    deleteComment: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        if (!req.user)
            return res.status(400).json({ msg: "invalid Authentication." });
        try {
            const comment = yield commentModel_1.Comment.findOneAndDelete({
                _id: req.params.id,
                $or: [
                    { user: req.user._id },
            ...
            if (comment.comment_root) {
                // update replyCM
                yield commentModel_1.Comment.findOneAndUpdate({ _id: comment.comment_root }, {
                    $pull: { replyCM: comment._id }
                });
            }
            else {
                // delete all comments in replyCM
                yield commentModel_1.Comment.deleteMany({ _id: { $in: comment.replyCM } });
            }
