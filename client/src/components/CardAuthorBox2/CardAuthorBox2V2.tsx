...
const CardAuthorBox2: FC<CardAuthorBox2Props> = ({
  ...
  const { name:displayName, href = "/", avatar, jobName, count, bgImage,id } = author;
  return (
    <NavLink
      to={`/profile/${id}`}
      ...
      <div className="relative flex-shrink-0 ">
        <div>
          <NcImage
            ...
            src='https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/A_black_image.jpg/2560px-A_black_image.jpg'
          />
        </div>
